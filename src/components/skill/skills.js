...
import skillss from "../../resource/skills.module.css"
export function SkillPage() {
    return (<>
       
    <main className={skillss.mainbody}>
        <h1>Technologies</h1>
   <div className={skillss.skillitems}>
    <i class="fa-brands fa-js"></i>
    <i class="fa-brands fa-react" id={skillss.React}></i>
    <i id="html" class="fa-brands fa-css3-alt" style={{color: "#379AD6", width: 96}}></i>
    <i id="css" class="fa-brands fa-html5" style={{color: "#FF5722", width: 96}}></i>
